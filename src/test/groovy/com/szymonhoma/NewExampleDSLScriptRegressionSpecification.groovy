...
@Unroll
class NewExampleDSLScriptRegressionSpecification extends JenkinsTestHarnessSpecificationBase implements XmlComparator {
    ...
    def setupSpec() {
        jobsToTest = generateJobsFor(NewExampleDSLScriptRegressionSpecification.getResource('RegressionExample.groovy'))
    }
